;(function(x,i){
var w=window,doc=document,d=navigator.userAgent,mn='__CFcoupletST',reqHead=('https:'==document.location.protocol)?'https://':'http://';
if(w[mn]===i){w[mn]=1}else{return}
if(top!=self && x.sitetype!=1){document.write('i!');return false;};
var rich ={dp0 : '',dp1 : '',dm:reqHead+'c.v4dwkcv.com/',
	ffb_url   : reqHead+x.domain+'/rich/ffb.php?ep=',track_url:reqHead+x.domain+'/f/track.php?step=1&ext=',
